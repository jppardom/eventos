                        ...
                        <div class="modal-content">
                            ...
                            <div class="row mb-3">
                                <div class="col-6 pr-1">
                                    <button type="button" id="btnTabCamera" class="btn btn-primary btn-block active" onclick="switchTab('camera')">
                                        📷 Escanear con Cámara
                                    </button>
                                </div>
                                <div class="col-6 pl-1">
                                    <button type="button" id="btnTabUpload" class="btn btn-outline-secondary btn-block" onclick="switchTab('upload')">
                            ...
                            <!-- Opción Cámara -->
                            <div id="tabCamera" class="tab-content active">
                                <div id="reader"></div>
                            </div>

                            <!-- Opción Subir Archivo (Convertido a ID para procesar con JS) -->
                            <div id="tabUpload" class="tab-content" style="display:none;">
                                <form id="formSubirQR" enctype="multipart/form-data">
                                    <p class="mt-2">
                                        <label>Selecciona imagen del QR:</label><br>
                                        <input type="file" id="qr_file" name="qr_file" accept="image/*" class="form-control" required>
                                    </p>
                                    <!-- type="button" para evitar la recarga del modal -->
                                    <button type="button" id="btnLeerQRFile" class="btn btn-primary">Leer QR de Imagen</button>
                                </form>
                            </div>
                        </div>
                        <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="crearInvitado" id="crearInvitado" class="form-control" required readonly>
